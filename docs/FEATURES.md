...
> v1.11.0 提供 5 个内置 Skills（docker、git、npm、python、testing），同时鼓励用户按项目需求创建自定义 Skills。Skill 基础设施（SkillManager、渐进式加载、system prompt 注入）保持不变。
...
**更多内置 Skills（5 -> 11，v1.11.0 保留 5 个核心 Skills：docker、git、npm、python、testing）**
