...
Cody 提供构建 AI 编程 Agent 所需的完整基础设施：**29 个工具、Agent Skills 开放标准、MCP/LSP 集成、子 Agent 编排、熔断器、跨任务记忆、会话管理和安全体系**。你可以用 SDK 将它嵌入任何 Python 应用，也可以直接用 CLI/TUI/Web 开箱即用。
...
| 痛点 | Cody 怎么解决 |
|------|--------------|
| 想自建 AI 编码工具，但从零造轮子太重 | 29 个工具 + 熔断器 + 安全体系 + Sessions 全现成，专注你的业务逻辑 |
