...
_LAZY_IMPORTS = {
    ...
    "SandboxExecutionRequest": (".sandbox", "SandboxExecutionRequest"),
    "SandboxExecutionResult": (".sandbox", "SandboxExecutionResult"),
    "SandboxSnapshot": (".sandbox", "SandboxSnapshot"),
    "SeatbeltSandboxBackend": (".sandbox", "SeatbeltSandboxBackend"),
    "BubblewrapSandboxBackend": (".sandbox", "BubblewrapSandboxBackend"),
    "DockerSandboxBackend": (".sandbox", "DockerSandboxBackend"),
    "RemoteSandboxBackend": (".sandbox", "RemoteSandboxBackend"),
    # runtime
    ...
    "AsyncMultiAgentCoordinator": (".runtime", "AsyncMultiAgentCoordinator"),
    "async_multi_agent_node_handler": (".runtime", "async_multi_agent_node_handler"),
    "AsyncQualityGateRunner": (".runtime", "AsyncQualityGateRunner"),
    "QualityGateFailure": (".runtime", "QualityGateFailure"),
    "async_quality_gate_node_handler": (".runtime", "async_quality_gate_node_handler"),
    "command_evaluator": (".runtime", "command_evaluator"),
    "diff_risk_evaluator": (".runtime", "diff_risk_evaluator"),
    "standard_quality_evaluators": (".runtime", "standard_quality_evaluators"),
    "AsyncWorkflowScheduleError": (".runtime", "AsyncWorkflowScheduleError"),
    "AsyncWorkflowScheduler": (".runtime", "AsyncWorkflowScheduler"),
    ...
    "runtime_root_for_workdir": (".runtime", "runtime_root_for_workdir"),
    "CodyRuntime": (".runtime", "CodyRuntime"),
    "RuntimeRun": (".runtime", "RuntimeRun"),
    "RuntimeRunResult": (".runtime", "RuntimeRunResult"),
    ...
    "idempotent_registry_tool_node_handler": (".runtime", "idempotent_registry_tool_node_handler"),
    ...
    "SQLiteWorkflowControlState": (".runtime", "SQLiteWorkflowControlState"),
    ...
    "run_event_to_stream_event": (".runtime", "run_event_to_stream_event"),
    # log
